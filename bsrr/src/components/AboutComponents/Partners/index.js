...
const Partners = () => {
  return (
  <section className=' mx-auto lg:flex max-w-7xl flex-col items-center mt-5 mb-20 hidden'>
  ...
  <div className='grid grid-cols-6 gap-20 text-[#252641] my-10 '>
  ...
  <h1 className='font-Nunito-Sans text-[#616161] text-2xl mt-8'>Олон Улсын Байгууллагууд:</h1>
  <div className='grid grid-cols-4 gap-20 text-[#252641] my-10 '>
    <div className='flex flex-col items-center justify-between'>
    <img className="w-24 h-24 mb-3"
          alt="partner1"
          src={partner1}
  ...
  <h1 className='font-Nunito-Sans text-[#616161] text-2xl mt-8'>Мал эмнэлэгүүд:</h1>
  <div className='grid grid-cols-6 gap-20 text-[#252641] my-10 '>
    <div className='flex flex-col items-center justify-between'>
    <img className="w-24 h-24 mb-3"
          alt="partner1"
    ...
    <div className='grid grid-cols-3 gap-20 text-[#252641] my-10 '>
    <div className=' flex flex-col items-center justify-between'>
    <img className="w-24 h-24 mb-3"
          alt="partner4"
          src={partner4}
