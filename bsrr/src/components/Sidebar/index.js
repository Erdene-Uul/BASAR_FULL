...
const Sidebar = (props) => {
  return (
    <div className="fixed h-screen w-2/3 sm:w-2/4 lg:hidden z-40 bg-white top-0 font-Roboto text-[#252641]">
      <Link to="/" className="flex cursor-pointer justify-center items-center mt-3">
          <div className="flex ">
